...
class HomeController extends Controller
{
   ...
   public function actionUserinfo(){//获取code码
      $redirect_uri=urlencode(Yii::$app->params['domain'].'qyz/home/test');
      $state=1;
      $codeUrl=sprintf(Yii::$app->params['qyz']['code'],Yii::$app->params['qyz']['app_id'],$redirect_uri,'snsapi_userinfo',$state);
