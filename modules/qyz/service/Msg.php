...
namespace api\modules\qyz\service;
...
class Msg
{
    public function checkSignature()
    {
        ...
        $token = Yii::$app->params['qyz']['token'];
...
//                  "Url"=>"https://mp.qyz.qq.com/s?__biz=MzU0ODYwNTQ3NA==&mid=2247483679&idx=1&sn=abfc6478cb03b0f4e3d4f7a0f65c7fec&chksm=fbbdda52ccca5344b00f370a7ab15c71e364ba5c2d89f7e24660d08f6721b6e991ce6df73518#rd"
//              ]
//            ]
//        ];
...
//                  </xml>";
        ...
        $url = "https://mp.qyz.qq.com/s?__biz=MzU0ODYwNTQ3NA==&mid=2247483725&idx=2&sn=340fe85432a47028991235da52655c46&chksm=fbbdda00ccca531665ee15aea51bf49c309e6a9bc4d89d13625eada6cf15d1a519a767d6f0e7#rd";
...
//}
    ...
    {//获取到用户的UnionID
        ...
        $sendUrl = sprintf(Yii::$app->params['qyz']['get_union_id'], $token, $openidf);
...
//        $appid=Yii::$app->params['wxLogin']['app_id'];
        ...
        $accessToken = new AccessToken();
        $token = $accessToken->get();
        $sendUrl = sprintf(Yii::$app->params['qyz']['custom'], $token);
        ...
        $menuArry = [
            "button" => [
                [
                    'type' => "view",
                    'name' => "编辑作品主页",
                    'url' => 'https://57418857.wechatzp.com/qyz/home/userinfo'
                ],
                [
                    "type" => "miniprogram",
                    "name" => "小程序",
                    "url" => "https://57418857.wechatzp.com/qyz/home/userinfo",//TODO 给一个不支持小程序的网页
                    "appid" => Yii::$app->params['wxLogin']['app_id'],
                ...
                [
                    'type' => "view",
                    'name' => "使用场景",
                    'url' => 'https://mp.qyz.qq.com/s?__biz=MzU0ODYwNTQ3NA==&mid=2247483725&idx=1&sn=8d7c070c0aab0b818e5c5a24879b9389&chksm=fbbdda00ccca5316855be307b75de1f72133eee0df4b47d89d2e3ca4ef240bd5db927bf277c9#rd'
                ]
            ]
        ];
        $accessToken = new AccessToken();
        $token = $accessToken->get();
        $sendUrl = sprintf(Yii::$app->params['qyz']['menu'], $token);
